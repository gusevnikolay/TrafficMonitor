...
int main(void)
{
  ...
  MX_USART3_UART_Init();
  MX_USB_DEVICE_Init();
	sserial_set_devname("TrafficMonitor v1.0         ");
...
static void MX_GPIO_Init(void){
  ...
  /*Configure GPIO pins : PB2 PB12 PB15 PB3 
                           PB4 PB5 */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_12|GPIO_PIN_15|GPIO_PIN_3 
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2|GPIO_PIN_12|GPIO_PIN_15|GPIO_PIN_3 
