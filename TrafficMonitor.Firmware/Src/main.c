...
void prepare_top_line()
{
		...
		top_line[9]  = (char)(hh/10 +0x30);
		top_line[10] = (char)(hh%10 +0x30);
	
		top_line[12] = (char)(mm/10 +0x30);
		top_line[13] = (char)(mm%10 +0x30);
	
		top_line[15] = (char)(ss/10 +0x30);
		top_line[16] = (char)(ss%10 +0x30);
}
